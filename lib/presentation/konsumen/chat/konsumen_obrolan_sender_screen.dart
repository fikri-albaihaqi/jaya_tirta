...
class KonsumenObrolanSenderScreen extends StatefulWidget {
  final String? obrolanId;
  final String senderUID;
  final String receiverUID;

  const KonsumenObrolanSenderScreen({
    Key? key,
    this.obrolanId,
  ...
  @override
  State<KonsumenObrolanSenderScreen> createState() =>
      _KonsumenObrolanSenderScreenState();
}

class _KonsumenObrolanSenderScreenState
    extends State<KonsumenObrolanSenderScreen> {
