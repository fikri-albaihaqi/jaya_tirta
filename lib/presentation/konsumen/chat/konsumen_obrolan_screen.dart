...
class KonsumenObrolanScreen extends StatefulWidget {
  final String? obrolanId;
  final Penjual penjual;
  final Konsumen konsumen;

  const KonsumenObrolanScreen({
    Key? key,
    this.obrolanId,
  ...
  @override
  State<KonsumenObrolanScreen> createState() => _KonsumenObrolanScreenState();
}

class _KonsumenObrolanScreenState extends State<KonsumenObrolanScreen> {
  @override
