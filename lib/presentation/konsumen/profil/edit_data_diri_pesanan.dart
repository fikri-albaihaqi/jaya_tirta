...
class EditDataDiriPesananScreen extends StatefulWidget {
  Produk produk;
  int total;
  int jumlah;
  User? user;
  ...
  @override
  State<EditDataDiriPesananScreen> createState() =>
      _EditDataDiriPesananScreenState();
}

class _EditDataDiriPesananScreenState extends State<EditDataDiriPesananScreen> {
